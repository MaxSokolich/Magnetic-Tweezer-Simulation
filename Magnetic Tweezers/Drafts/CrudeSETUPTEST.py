...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 17 09:47:01 2021
...
measurement_location = [0*micro,0*micro]         # microbot position of interest



IBottom = 0                                          # Applied current to left coil/pole in Amps
ITop = .0                                     # Applied current to top coil/pole in Amps
IRight = -.5                                       # Applied.5urrent to right coil/pole in Amps
...
#System Properties
Pole_Pole_Distance = 6000 * micro                   # pole to pole distance in um, defines workspace area
L = (Pole_Pole_Distance/2)                         # length to center of workspace
Gradient_Space = (L/4)                             # Maximum gradient estimation distance 
I_max = 3                                         # Maximum current to avoid pole saturation --> value taken from paper
NTurns = 300                                        # number of turns on a single coil --> taken from paper
                        # magnetic resitance of air gap --> value from paper 



#MICROSPHERE PROPERTIES
Bead_Diameter = (23.8 *micro)                       # bead diameter in micrometers
...
gridp = 60                                         # grid resolution of magnetic streamlines
...
plt.title("FORCE FIELD OF WORKSPACE CORRESPONSING TO DESIRED INPUT CURRENTS")
plt.xlim(-Pole_Pole_Distance/2,(Pole_Pole_Distance)/2)
plt.ylim(-Pole_Pole_Distance/2,(Pole_Pole_Distance)/2)
plt.xlabel("x (um)")
plt.ylabel("y (um)")
